...
<div class="container-fluid overflow-scroll">
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-primary m-0 font-weight-bold">Data Pemasukan</p>
        </div>
        <div class="card-body">
                        ...
                        <?php if ($i == 1) : ?>
                            <tr>
                                <td colspan="7" class="text-center">
                                    ...
                                    <a href="<?= base_url('/pemilik/tambah_transaksi'); ?>" class="btn btn-primary btn-sm d-none d-sm-inline-block mb-3">Tambah Transaksi</button>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
